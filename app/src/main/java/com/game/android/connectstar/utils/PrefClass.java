package com.game.android.connectstar.utils;

import android.content.Context;
import android.content.SharedPreferences;

import com.game.android.connectstar.R;
...
public class PrefClass {
	...
	public static void setAdsVar(int value) {
		if (value == context.getResources().getInteger(
				R.integer.interstitial_interval))
			value = 0;
		edit = pref.edit();
	...
	public static int getColor() {
		return pref.getInt("COLOR",
				context.getResources().getColor(R.color.pack5));
	}
